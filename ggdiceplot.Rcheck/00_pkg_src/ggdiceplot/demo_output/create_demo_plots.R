...
p_dense <- ggplot(dense_data, aes(x = x, y = y, categories = categories)) +
  geom_dice(category_positions = category_positions, dice_size = 0.6) +
  scale_x_continuous(breaks = 1:6, limits = c(0.8, 6.2)) +
  scale_y_continuous(breaks = 1:6, limits = c(0.8, 6.2)) +
...
p_sparse <- ggplot(sparse_data, aes(x = x, y = y, categories = categories)) +
  geom_dice(category_positions = category_positions, dice_size = 1.0) +
...
p_reference <- ggplot(ref_data, aes(x = x, y = y, categories = categories)) +
  geom_dice(category_positions = category_positions, dice_size = 1.0) +
  scale_x_continuous(breaks = 1:6, limits = c(0.8, 6.2)) +
  scale_y_continuous(breaks = 1, limits = c(0.8, 1.2)) +
